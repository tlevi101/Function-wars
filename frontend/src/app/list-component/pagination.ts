export class Pagination {
    ...
    handlePageTurn() {
        if (this.first > this.page && this.first !== 2) this.first = this.first - this.SLIDER_SIZE;
        ...
        if (this.pageCount <= this.page + this.SLIDER_SIZE) this.first = this.pageCount - this.SLIDER_SIZE;
